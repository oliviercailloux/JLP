...
/**
 * This class contains facility methods to build a new solver instance. The simplest way to use it is to call the static
 * {@link #newSolver(LpSolverType)} method.
 * 
...
public class LpSolverFactory {
     ...
     * </p>
     * <p>
     * This method wraps exceptions that can be thrown because of an instanciation problem in a higher-level exception.
     * </p>
     * 
     * @param <V>
    ...
    /**
     * <p>
     * Creates a new solver instance corresponding to the chosen solver type. This factory will search for the
     * corresponding implementing class in the classpath, using a class name dependent on the chosen solver type. This
     * will fail if the classpath does not contain the expected implementing class.
     * </p>
     * 
     * @param impl
     *            not <code>null</code>.
     ...
     * 
     * @throws LpSolverFactoryException
     *             if anything goes wrong when instanciating the solver: the expected class is not found in the
     *             classpath, or a security policy prevents accessing it or its constructor.
     */
     ...
     *             </ul>
     */
    public <V> LpSolver<V> newSolverThrowing() throws ClassNotFoundException, InstantiationException,
