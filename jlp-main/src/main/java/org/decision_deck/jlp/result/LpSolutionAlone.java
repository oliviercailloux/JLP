...
/**
 * <p>
 * A valid, but not necessarily optimal, solution to a mathematical program. The problem that this solution satisfies is
 * <em>not</em> bound to this solution object. The interface {@link LpSolution} should be preferred to this one when the
 * related problem can be bound to the solution, see documentation there.
 * </p>
 * 
 * @param <V>
...
public interface LpSolutionAlone<V> {
    ...
    /**
     * Returns the primal value of the variable, if it is known. TODO indicate what happens if variable is unknown.
     * 
     * @param variable
     *            not <code>null</code>.
