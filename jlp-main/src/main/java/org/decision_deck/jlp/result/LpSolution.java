...
/**
 * <p>
 * A feasible, but not necessarily optimal, result of a {@link LpProblem}. The problem that this solution satisfies is
 ...
 * {@link Number#doubleValue()} for the objective value and the variables (primal and dual) values, and their bound
 * problem is equal.
 * </p>
 * <p>
 * This interface has been designed for use with immutable numbers. The types {@link Double}, {@link Integer},
 * {@link BigDecimal}, {@link BigInteger} will pose no problem. Using other types as numbers is unsupported.
 * </p>
 * 
 * @param <V>
...
public interface LpSolution<V> extends LpSolutionAlone<V> {
    ...
    /**
     * <p>
     * A convenience method to return the primal value of the given variable as a boolean. This method takes the solver
     * parameters into account to determine if a value represents a boolean <code>true</code> or <code>false</code>,
     * even when the value is different than 1d or 0d. This may be so e.g. because the solver introduces tolerances,
     * thus a value of 0.00001 may be a boolean <code>false</code>. If the value of the given variable does not
     * correspond to a boolean, e.g. because its value is more different than zero and than one than allowed by the
     * tolerance used by the given solver, this method throws an exception.
     * </p>
     * TODO the implementation should use a tolerance depending on the solver, currently is fixed at 1e-6.
     * <p>
