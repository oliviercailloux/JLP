 ...
 * having the type {@link LpVariableType#BOOL} and lower and upper bounds <em>&lt;l, u></em>. This view sees it as a
 * variable of type {@link LpVariableType#INT} with as lower bound the integer 0 if <em>l</em>.doubleValue() is lower
 * than zero or if <em>l</em> is negative infinity, and <em>l</em> otherwise; and as upper bound the integer 1 if
 * <em>u</em>.doubleValue() is greater than one or <em>u</em> is positive infinity, and <em>u</em> otherwise. Thus a
 * {@link LpVariableType#BOOL} variable with bounds of <-1, 0.5> become, through the view, an {@link LpVariableType#INT}
 * variable with bounds of <0, 0.5>. The rest of the data is viewed unmodified.
 * </p>
 * <p>
 ...
 * </p>
 * <p>
 * This object does not change iteration order of set of constraints and the set of variables: iteration order of these
 * sets is the order used by the delegate.
 * 
 * @param <V>
