package io.github.oliviercailloux.jlp.minisat;
...
/**
 * <p>
 * The <a href="http://minisat.se/MiniSat+.html">MiniSat+</a> solver. The bounds
 * of all variables must be defined and be between zero and one, or the variable
 * type must be {@link LpVariableType#BOOL}.
 * </p>
 * <p>
 * Note that the implementation is most probably incomplete. This has not been
 * thoroughly tested. Help is welcome.
 * </p>
 * 
 * @param <T>
...
public class SolverMiniSat<T> extends AbstractLpSolver<T> {
	...
	/**
	 * Retrieves the mapping between the variable objects used in the problem and
	 * the variable ids used by minisat. This is guaranteed to be initialized after
	 * having called {@link #getUnderlyingSolver()} or {@link #solve()}.
	 * 
