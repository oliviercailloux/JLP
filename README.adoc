...
image:https://sonarcloud.io/api/project_badges/measure?project=io.github.oliviercailloux%3Ajlp&metric=alert_status["SonarCloud Status", link="https://sonarcloud.io/dashboard?id=io.github.oliviercailloux%3Ajlp"]
