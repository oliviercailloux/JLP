 ...
 * appropriate enum types, i.e. {@link LpDoubleParameter},
 * {@link LpIntParameter}, {@link LpStringParameter}, {@link LpObjectParameter}.
 ...
 * a value of one for the parameter {@link LpIntParameter#DETERMINISTIC} would
 ...
 * {@link LpIntParameter#DETERMINISTIC} is necessarily supported. In that
 ...
 * </p>
 * <p>
 * The class {@link LpParametersUtils} may be used to determine whether a value
 * is meaningful for a given parameter, see for example
 * {@link LpParametersUtils#getValidator(LpDoubleParameter)}.
 * </p>
 * <p>
 ...
 * </p>
 * <p>
 * Two {@link LpParameters} objects are equal, as determined by {@link #equals},
 ...
 * value for the parameter {@link LpObjectParameter#NAMER_VARIABLES}.
 * </p>
 * <p>
 * When two {@link LpParameters} objects have the default value for a given
 * parameter, these values are guaranteed to be considered equal because all
 * {@link LpParameters} objects share the same defaults.
 * </p>
 * 
...
public interface LpParameters {
	 ...
	 *         {@link LpParameters} object and contains the same value for each
	 ...
	 * 
	 * @param parameter
	 *            not <code>null</code>. The type must be {@link LpIntParameter},
	 *            {@link LpDoubleParameter}, {@link LpStringParameter} or
	 *            {@link LpObjectParameter}.
	 ...
	 * the value given by {@link LpParametersDefaultValues}.
	 * 
	 * @param parameter
	 *            not <code>null</code>.
	 * @param value
	 ...
	 * Sets the value associated with a parameter. The value must be a meaningful
	 * value for that parameter. To restore a parameter to its default value, use
	 * the value given by {@link LpParametersDefaultValues}. This is a non type safe
