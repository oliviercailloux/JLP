...
public class SolverCPLEX<T> extends AbstractLpSolver<T> {
     ...
     * {@inheritDoc}
     * <p>
     * Note that this goes through a temporary file because cplex does not allow exporting to a stream.
     * </p>
     */
    @Override
	...
	/**
	 * Note that cplex 12.2 writes in unknown default export format (perhaps ISO 8859-1?) and this method assumes
	 * export is in UTF-8. Therefore, it might not work. However, oddly enough, tests show it seems to work.
	 */
